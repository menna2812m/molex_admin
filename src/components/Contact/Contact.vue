        ...
        <div class="card p-3 border-1 mb-3" v-for="(item, i) in items" :key="i">
          <div class="d-flex justify-content-between border-bottom">
            <h4 class="mb-0">
              ...
              <span v-if="perminlocal.includes('contacts-seen')">
                <i
                  v-if="item.is_seen === 0"
                  class="fe fe-eye-off text-info"
                  style="cursor: pointer; color: rgb(38, 202, 38)"
                  @click="seenmessage(item.id)"
                ></i>
              </span>
             ...
             "message": "bkrhkooo" -->
              ...
              <button
                ...
                style="
                  ...
                  height: max-content;
                "
                v-if="perminlocal.includes('contacts-destroy')"
              >
