    ...
    <div class="page-header">
      <div class="row align-items-center">
        <div class="col">
          ...
          <p class="mt-3 mb-0">مرحباً بك في لوحة تحكم الأدمن</p>
        </div>
      </div>
    </div>
    <section class="mt-2 pt-2" v-if="perminlocal.includes('statistics-index')">
            ...
            <div class="card-body">
              <div class="card-order">
                ...
                <h2 class="text-end card-item-icon card-icon">
                  <i
                    class="float-start text-white"
                    :class="admin[key]?.icon"
                  ></i>
